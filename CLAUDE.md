...
- **A struct-field add needs `--all-targets` on every CONSTRUCTING crate.** → [`a-struct-field-add-breaks-constructing-crates`](docs/method-rules.md#a-struct-field-add-breaks-constructing-crates)
