use candle_core_types::CpuStorageRef;
use candle_core_types::dtype::WithDType;
use candle_core_types::{CpuStorage, DType, Layout, Result, Shape};
...
impl CudaDevice {
    ...
    pub fn location(&self) -> candle_core_types::DeviceLocation {
        candle_core_types::DeviceLocation::Cuda {
    ...
    pub fn synchronize(&self) -> Result<()> {
        self.stream.synchronize().map_err(candle_core_types::Error::wrap)?;
        Ok(())
    }
}
