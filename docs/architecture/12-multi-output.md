...
- Session prompts: [`docs/session-prompts/multi-output-nodes-option-c.md`](../session-prompts/multi-output-nodes-option-c.md) for the original design rationale; [`docs/session-prompts/selective-scan-ssd-chunk-multi-output-followup.md`](../session-prompts/selective-scan-ssd-chunk-multi-output-followup.md) for the consumer migrations.
