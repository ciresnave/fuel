...
Many classical layers (such as [Linear](https://github.com/huggingface/fuel/blob/main/fuel-nn/src/linear.rs)) are already implemented in [fuel-nn](https://github.com/huggingface/fuel/tree/main/fuel-nn).
...
Let's simplify our implementation. First, add `fuel-nn` as a dependency:
