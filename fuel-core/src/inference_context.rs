...
/// ([`LlamaModel::forward_paged_step_persistent`](fuel_model_llama::LlamaModel::forward_paged_step_persistent)):
...
/// [`LlamaModel::forward_paged_step`](fuel_model_llama::LlamaModel::forward_paged_step);
...
pub struct InferenceContext {
    ...
    /// Held plan-once decode plan for [`fuel_model_llama::LlamaModel::forward_decode_step`]
...
impl InferenceContext {
    ...
    /// [`fuel_model_llama::LlamaModel::forward_decode_step`] holds one.
