...
fn fused_linear_realizes_same_as_matmul_plus_bias() {
    ...
    let a2 = LazyTensor::from_f32(a_data, Shape::from_dims(&[2, 5]));
    ...
    let bias2_b = bias2.broadcast_to(Shape::from_dims(&[2, 7]));
