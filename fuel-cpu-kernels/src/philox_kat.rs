...
//!   repo  DEShawResearch/random123      <- no hyphen
...
//!   curl -sS https://raw.githubusercontent.com/DEShawResearch/random123/main/tests/old_kat_vectors
//!   awk '$1=="philox4x32" && $2==10 { ... }'   (see docs/superpowers/specs/2026-07-31-rng-generator-seam-design.md §10)
//!
//! Hand-transcription is recall with extra steps; §10 forbids it. If these need
//! updating, re-run the fetch + generator, do not retype.

/// `(counter[4], key[2], expected[4])` for `philox4x32_R(10, ctr, key)`.
pub const PHILOX4X32_10_KAT: &[([u32; 4], [u32; 2], [u32; 4])] = &[
    (
