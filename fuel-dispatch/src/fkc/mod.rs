...
pub use cpu_link::{
    ...
    CPU_COMPARE_ENTRY_POINTS, CPU_CONV_ENTRY_POINTS, CPU_MATMUL_ENTRY_POINTS,
    CPU_NORM_BACKWARD_ENTRY_POINTS, CPU_NORM_ENTRY_POINTS, CPU_PADDING_ENTRY_POINTS,
    CPU_REDUCE_ENTRY_POINTS, CPU_REDUCE_TO_ENTRY_POINTS, CPU_ROPE_ENTRY_POINTS,
    CPU_SHAPE_OPS_ENTRY_POINTS, CPU_SSM_ENTRY_POINTS, CPU_UNARY_ENTRY_POINTS,
    CPU_WHERE_ENTRY_POINTS,
};
