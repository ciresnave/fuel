...
pub fn download_model(model_and_revision: &str) -> Result<()> {
    ...
    println!("cargo::rustc-env=FUEL_BUILDTIME_MODEL_CONFIG={config_filename}");
    println!("cargo::rustc-env=FUEL_BUILDTIME_MODEL_TOKENIZER={tokenizer_filename}");
    println!("cargo::rustc-env=FUEL_BUILDTIME_MODEL_WEIGHTS={weights_filename}");
