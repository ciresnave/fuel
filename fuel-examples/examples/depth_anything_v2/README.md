...
```bash
cargo run --features cuda,depth_anything_v2 --package fuel-examples --example depth_anything_v2 -- --color-map --image fuel-examples/examples/yolo-v8/assets/bike.jpg 
```
