...
pub fn run(args: &crate::TrainingCmd, common_args: &crate::Args) -> Result<()> {
    ...
    let varmap = fuel_nn::VarMap::new();
    let vb = fuel_nn::VarBuilder::from_varmap(&varmap, DType::F32, &device);
    ...
    let params = fuel_nn::ParamsAdamW {
        lr: args.learning_rate,
        ..Default::default()
    };
    let mut opt = fuel_nn::AdamW::new(varmap.all_vars(), params)?;
