...
pub type Config = fuel_transformers::models::llama::LlamaConfig;
...
fn shard(dim: usize, rank: usize, world_size: usize) -> fuel_nn::var_builder::Shard {
    fuel_nn::var_builder::Shard {
        dim,
        rank,
        world_size,
    }
...
impl CausalSelfAttention {
    ...
    fn repeat_kv(&self, x: Tensor) -> Result<Tensor> {
        ...
        fuel_transformers::utils::repeat_kv(x, n_rep)
    }
