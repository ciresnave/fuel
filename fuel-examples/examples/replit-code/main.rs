...
use fuel_transformers::models::mpt::{Config, Model as M};
use fuel_transformers::models::quantized_mpt::Model as Q;
...
impl Model {
    fn forward(&mut self, xs: &Tensor) -> fuel::Result<Tensor> {
        match self {
...
fn main() -> Result<()> {
    ...
    let model_id = match args.model_id {
        ...
        None => "lmz/fuel-replit-code".to_string(),
    };
