...
cargo run --example segformer classify fuel-examples/examples/yolo-v8/assets/bike.jpg

# run the segmentation task
cargo run --example segformer segment fuel-examples/examples/yolo-v8/assets/bike.jpg
...
[pr]: https://github.com/huggingface/fuel/pull/1617
