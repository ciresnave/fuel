...
**Compilation errors**: Ensure you're using the latest version of the Fuel crate

## License

This implementation follows the Fuel framework license. SmolLM3 models are available under Apache 2.0.