...
*A cute rusty robot holding a fuel torch in its hand, with glowing neon text \"LETS GO RUSTY\" displayed on its chest, bright background, high quality, 4k*, generated by Stable Diffusion 3 Medium
...
cargo run --example stable-diffusion-3 --release --features=cuda -- \
  ...
  --prompt 'A cute rusty robot holding a fuel torch in its hand, with glowing neon text \"LETS GO RUSTY\" displayed on its chest, bright background, high quality, 4k'
```
