...
```bash
$ cargo run --example t5 --release -- --model-id "t5-small" --prompt "translate to German: A beautiful fuel." --decode
...
 Eine schöne Kerze.
...
```bash
$ cargo run --example t5 --release -- --model-id "t5-small" --prompt "A beautiful fuel."
...
