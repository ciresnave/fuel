...
```bash
cargo run --example trocr --release -- --image fuel-examples/examples/trocr/assets/trocr.png
cargo run --example trocr --release -- --which large --image fuel-examples/examples/trocr/assets/trocr.png
cargo run --example trocr --release -- --which base-printed --image fuel-examples/examples/trocr/assets/noto.png
cargo run --example trocr --release -- --which large-printed --image fuel-examples/examples/trocr/assets/noto.png
```
