...
use fuel_onnx::eval::{dtype, get_tensor, simple_eval};
use fuel_onnx::onnx::tensor_proto::DataType;
use fuel_onnx::onnx::tensor_shape_proto::dimension::Value;
use fuel_onnx::onnx::type_proto::{Tensor as ONNXTensor, Value as ONNXValue};
use fuel_onnx::onnx::{ModelProto, ValueInfoProto};
...
impl PyONNXModel {
    ...
    fn new(path: String) -> PyResult<Self> {
        let model: ModelProto = fuel_onnx::read_file(path).map_err(wrap_err)?;
