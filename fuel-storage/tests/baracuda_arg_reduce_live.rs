...
fn baracuda_argmax_dim_f32_last_axis() {
    ...
    let got = run_arg(
        ...
        OpKind::ArgMaxDim,
        DType::F32,
        fuel_storage::baracuda_dispatch::arg_reduce::argmax_dim_u32_f32,
        &input,
        &[2, 3],
        1,
    );
...
fn baracuda_argmin_dim_f32_last_axis() {
    ...
    let got = run_arg(
        ...
        OpKind::ArgMinDim,
        DType::F32,
        fuel_storage::baracuda_dispatch::arg_reduce::argmin_dim_u32_f32,
        &input,
        &[2, 3],
        1,
    );
...
fn baracuda_argmax_dim_f64_ties_break_to_smallest_index() {
    ...
    let got = run_arg(
        ...
        OpKind::ArgMaxDim,
        DType::F64,
        fuel_storage::baracuda_dispatch::arg_reduce::argmax_dim_u32_f64,
        &input,
        &[2, 3],
        1,
    );
