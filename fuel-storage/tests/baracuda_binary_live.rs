...
fn baracuda_binary_add_f32_runs_through_binding_table() {
    ...
    let got = run_binary_f32(
        ...
        fuel_storage::baracuda_dispatch::binary::add_f32,
        &[1.0_f32, 2.0, 3.0, 4.0],
...
fn baracuda_binary_mul_f32_runs_through_binding_table() {
    ...
    let got = run_binary_f32(
        ...
        fuel_storage::baracuda_dispatch::binary::mul_f32,
        &[1.0_f32, 2.0, 3.0, 4.0],
        &[10.0_f32, 20.0, 30.0, 40.0],
    )
    .expect("kernel call");
...
fn baracuda_binary_div_f32_runs_through_binding_table() {
    ...
    let got = run_binary_f32(
        ...
        fuel_storage::baracuda_dispatch::binary::div_f32,
        &[10.0_f32, 20.0, 30.0, 40.0],
        &[1.0_f32, 2.0, 3.0, 4.0],
    )
    .expect("kernel call");
...
fn baracuda_binary_maximum_f32_runs_through_binding_table() {
    ...
    let got = run_binary_f32(
        ...
        fuel_storage::baracuda_dispatch::binary::maximum_f32,
