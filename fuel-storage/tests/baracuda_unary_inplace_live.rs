...
fn baracuda_relu_inplace_f64() {
    ...
    let out = run_unary_inplace(
        ...
        OpKind::ReluInplace,
        DType::F64,
        fuel_storage::baracuda_dispatch::unary::relu_inplace_f64,
        &input,
    );
...
fn baracuda_silu_inplace_bf16() {
    ...
    let out = run_unary_inplace(
        ...
        OpKind::SiluInplace,
        DType::BF16,
        fuel_storage::baracuda_dispatch::unary::silu_inplace_bf16,
        &input,
    );
...
fn baracuda_sigmoid_inplace_f16() {
    ...
    let out = run_unary_inplace(
        ...
        OpKind::SigmoidInplace,
        DType::F16,
        fuel_storage::baracuda_dispatch::unary::sigmoid_inplace_f16,
        &input,
    );
