...
fn baracuda_unary_neg_f32_runs_through_binding_table() {
    ...
    let got = run_unary_f32(
        ...
        fuel_storage::baracuda_dispatch::unary::neg_f32,
        &[1.0_f32, -2.0, 3.0, -4.0],
    )
    .expect("kernel call");
...
fn baracuda_unary_abs_f32_runs_through_binding_table() {
    ...
    let got = run_unary_f32(
        ...
        fuel_storage::baracuda_dispatch::unary::abs_f32,
        &[1.0_f32, -2.0, 3.0, -4.0],
    )
    .expect("kernel call");
    assert_eq!(got, vec![1.0_f32, 2.0, 3.0, 4.0]);
...
fn baracuda_unary_sqrt_f32_runs_through_binding_table() {
    ...
    let got = run_unary_f32(
        ...
        fuel_storage::baracuda_dispatch::unary::sqrt_f32,
...
fn baracuda_unary_relu_f32_runs_through_binding_table() {
    ...
    let got = run_unary_f32(
        ...
        fuel_storage::baracuda_dispatch::unary::relu_f32,
        &[1.0_f32, -2.0, 0.0, 3.0],
    )
    .expect("kernel call");
