...
/// GGUF-quantised two-layer SiLU MLP embedder.
#[derive(Debug, Clone)]
...
/// GGUF-quantised per-head RMS Q/K normalisation.
#[derive(Debug, Clone)]
pub struct QkNorm {
    query_norm: RmsNorm,
    key_norm: RmsNorm,
...
/// GGUF-quantised single-stream self-attention module.
#[derive(Debug, Clone)]
...
/// GGUF-quantised dual-stream (image + text) transformer block.
#[derive(Debug, Clone)]
...
/// GGUF-quantised merged single-stream transformer block.
#[derive(Debug, Clone)]
...
/// GGUF-quantised final output projection layer.
#[derive(Debug, Clone)]
...
/// GGUF-quantised full Flux transformer model.
#[derive(Debug, Clone)]
pub struct Flux {
    img_in: Linear,
    txt_in: Linear,
...
impl Flux {
    /// Build the quantised Flux model from config.
