...
/// Linearly spaced tensor of `steps` values from `start` to `stop` (inclusive).
...
/// Piecewise-linear interpolation of `x` values into the piecewise function defined by `(xp, fp)`.
