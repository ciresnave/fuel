...
//! - See modernbert in [fuel-examples](https://github.com/huggingface/fuel/tree/main/fuel-examples/) for runnable code
//!
...
///
/// ```no_run
/// # let cfg: fuel_transformers::models::modernbert::Config = unimplemented!(); // Typically loaded from JSON
/// ```
...
/// Pooling strategy for ModernBERT classification heads.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::modernbert::ClassifierPooling;
/// let p = ClassifierPooling::CLS;
/// ```
...
/// Classifier-specific configuration for ModernBERT.
///
/// # Example
///
/// ```no_run
/// # let cc: fuel_transformers::models::modernbert::ClassifierConfig = unimplemented!(); // Loaded from JSON
/// ```
#[derive(Debug, Clone, PartialEq, Deserialize)]
...
impl RotaryEmbedding {
    ...
    fn apply_rotary_emb_qkv(&self, q: &Tensor, k: &Tensor) -> Result<(Tensor, Tensor)> {
        let q_embed = fuel_nn::rotary_emb::rope(&q.contiguous()?, &self.cos, &self.sin)?;
        let k_embed = fuel_nn::rotary_emb::rope(&k.contiguous()?, &self.cos, &self.sin)?;
        Ok((q_embed, k_embed))
    }
}
...
/// ModernBERT MLP feed-forward sub-layer.
#[derive(Clone)]
...
/// Single ModernBERT transformer layer (attention + MLP).
#[derive(Clone)]
...
/// ModernBERT LM / classification head.
#[derive(Clone)]
...
/// ModernBERT vocabulary decoder (head + tied embedding).
#[derive(Clone)]
...
// ModernBERT backbone
/// ModernBERT encoder backbone (embeddings + stacked layers).
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::modernbert::{Config, ModernBert};
...
impl ModernBert {
    /// Load the ModernBERT backbone from a variable store.
    ///
    /// # Example
    ///
    /// ```no_run
...
/// ModernBERT model for masked language modelling.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::modernbert::{Config, ModernBertForMaskedLM};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
...
impl ModernBertForMaskedLM {
    /// Load the MLM model from a variable store.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// Run forward pass and return per-token vocabulary logits.
    ///
    /// # Example
    ///
    /// ```no_run
...
/// Internal ModernBERT classifier projection layer.
#[derive(Clone)]
...
/// ModernBERT model for sequence-level classification.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::modernbert::{Config, ModernBertForSequenceClassification};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
