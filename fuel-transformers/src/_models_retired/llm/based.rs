...
use fuel_nn::{
    conv1d_no_bias, kv_cache::KvCache, linear, linear_no_bias, ops::softmax_last_dim, rms_norm,
    Conv1d, Conv1dConfig, Func, Linear, RmsNorm, VarBuilder,
};
use std::collections::HashMap;
use std::sync::Arc;

/// Configuration for the linear-attention feature-map sub-module.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::based::LinearAttentionFeatureMapConfig;
/// # let cfg: LinearAttentionFeatureMapConfig = unimplemented!(); // Loaded from JSON config.
/// ```
...
/// Configuration for a linear-attention layer.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::based::LinearAttentionConfig;
/// # let cfg: LinearAttentionConfig = unimplemented!(); // Loaded from JSON config.
/// ```
#[derive(Debug, Clone, serde::Deserialize)]
...
/// Configuration for a sliding-window attention layer.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::based::SlidingWindowAttentionConfig;
/// # let cfg: SlidingWindowAttentionConfig = unimplemented!(); // Loaded from JSON config.
/// ```
#[derive(Debug, Clone, serde::Deserialize)]
...
/// Top-level configuration for the Based language model.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::based::Config;
/// # let cfg: Config = unimplemented!(); // Typically loaded from a JSON config file.
/// ```
#[derive(Debug, Clone, serde::Deserialize)]
pub struct Config {
    vocab_size: usize,
...
// Not using Activation::Swiglu because this has the gate and y arguments switched compared to the version in fuel-nn/src/ops.rs
...
/// Based (linear-attention hybrid) language model.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::based::{Config, Model};
...
impl Model {
    ...
    /// # use fuel_transformers::models::based::Model;
