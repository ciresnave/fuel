...
/// Per-layer RoPE configuration overrides.
...
/// Full and sliding-window RoPE parameters for Gemma 4.
#[derive(Debug, Clone, PartialEq, serde::Deserialize)]
...
/// Configuration for the Gemma 4 text decoder.
#[derive(Debug, Clone, PartialEq, serde::Deserialize)]
...
impl Gemma4TextConfig {
    /// Returns the effective sliding-window size, accounting for bidirectional attention.
    ...
    /// Returns the partial rotary factor for global attention RoPE.
    ...
    /// Returns the base frequency for local (sliding-window) RoPE.
...
/// Configuration for the Gemma 4 vision tower (ViT encoder).
#[derive(Debug, Clone, PartialEq, serde::Deserialize)]
...
impl Gemma4VisionConfig {
    /// Returns the RoPE theta for the vision encoder.
...
/// Configuration for the Gemma 4 Conformer audio encoder.
#[derive(Debug, Clone, PartialEq, serde::Deserialize)]
...
/// Top-level configuration for the Gemma 4 multimodal model.
#[derive(Debug, Clone, PartialEq, serde::Deserialize)]
