...
//!
//! - ⚡ [Interactive Wasm Example](https://huggingface.co/spaces/lmz/fuel-llama2)
...
use fuel_nn::linear_no_bias as linear;
use fuel_nn::{embedding, kv_cache::KvCache, rms_norm, Embedding, Linear, Module, RmsNorm, VarBuilder};
...
///
/// ```no_run
/// # use fuel_transformers::models::llama2_c::{Cache, Config};
...
///
/// ```no_run
/// # use fuel_transformers::models::llama2_c::{Cache, Config, Llama};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::tiny_15m();
...
impl Llama {
    ...
    ///
    /// ```no_run
    /// # use fuel_transformers::models::llama2_c::{Config, Llama};
    /// # use fuel_nn::VarBuilder;
    /// # let vb: VarBuilder = unimplemented!();
    /// let cfg = Config::tiny_15m();
    /// let model = Llama::load(vb, cfg)?;
