...
impl ClipTextEmbeddings {
    fn new(vs: fuel_nn::VarBuilder, c: &ClipTextConfig) -> Result<Self> {
        let token_embedding =
            fuel_nn::embedding(c.vocab_size, c.embed_dim, vs.pp("token_embedding"))?;
        let position_embedding: nn::Embedding = fuel_nn::embedding(
...
impl ClipAttention {
    fn new(vs: fuel_nn::VarBuilder, c: &EncoderConfig) -> Result<Self> {
...
impl ClipEncoder {
    pub fn new(vs: fuel_nn::VarBuilder, c: &EncoderConfig) -> Result<Self> {
        let vs = vs.pp("layers");
...
impl ClipTextTransformer {
    pub fn new(vs: fuel_nn::VarBuilder, c: &ClipTextConfig) -> Result<Self> {
