...
/// Quantised Mistral causal language model.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::quantized_mistral::Model;
/// # use fuel_transformers::models::quantized_mistral::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: fuel_transformers::models::mistral::Config = unimplemented!();
...
impl Model {
    /// Construct a quantised Mistral model from config and a quantised variable store.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::quantized_mistral::Model;
