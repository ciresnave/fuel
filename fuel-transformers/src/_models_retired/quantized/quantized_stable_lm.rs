...
use fuel_nn::{Activation, LayerNorm};
...
/// Quantised StableLM causal language model.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_stable_lm::{Model, Config};
/// use fuel_transformers::models::quantized_stable_lm::VarBuilder;
/// use fuel::Device;
...
impl Model {
    /// Construct a quantised StableLM model from config and a quantised variable store.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::quantized_stable_lm::Model;
    /// # use fuel_transformers::models::quantized_stable_lm::VarBuilder;
    /// # fn main() -> fuel::Result<()> {
    /// # let vb: VarBuilder = unimplemented!();
    /// # let cfg: fuel_transformers::models::stable_lm::Config = unimplemented!();
    /// let model = Model::new(&cfg, vb)?;
    /// # Ok(())
    /// # }
    /// ```
    ...
    /// Run a forward pass; returns logits with shape `(batch, vocab_size)`.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::quantized_stable_lm::Model;
