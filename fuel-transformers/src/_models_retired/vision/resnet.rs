...
use fuel::{Result, D};
use fuel_nn::{batch_norm, Conv2d, Func, VarBuilder};
...
fn conv2d(
    ...
    fuel_nn::conv2d_no_bias(c_in, c_out, ksize, conv2d_cfg, vb)
}
...
fn resnet(
    ...
    let fc = match nclasses {
        None => None,
        Some(nclasses) => {
            let linear = fuel_nn::linear(512, nclasses, vb.pp("fc"))?;
            Some(linear)
        }
    };
    Ok(Func::new(move |xs| {
...
///
/// Uses basic blocks with layer counts `[2, 2, 2, 2]`.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::resnet::resnet18;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = resnet18(1000, vb)?;
/// # Ok(())
/// # }
/// ```
...
/// Creates a ResNet-18 model without the final classification layer.
///
/// Returns features of size 512 after global average pooling.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::resnet::resnet18_no_final_layer;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = resnet18_no_final_layer(vb)?;
/// # Ok(())
/// # }
/// ```
...
///
/// Uses basic blocks with layer counts `[3, 4, 6, 3]`.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::resnet::resnet34;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = resnet34(1000, vb)?;
/// # Ok(())
/// # }
/// ```
...
/// Creates a ResNet-34 model without the final classification layer.
///
/// Returns features of size 512 after global average pooling.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::resnet::resnet34_no_final_layer;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = resnet34_no_final_layer(vb)?;
/// # Ok(())
/// # }
/// ```
...
fn bottleneck_resnet(
    ...
    let fc = match nclasses {
        None => None,
        Some(nclasses) => {
            let linear = fuel_nn::linear(4 * 512, nclasses, vb.pp("fc"))?;
            Some(linear)
        }
    };
    Ok(Func::new(move |xs| {
...
///
/// Uses bottleneck blocks with layer counts `[3, 4, 6, 3]`.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::resnet::resnet50;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = resnet50(1000, vb)?;
/// # Ok(())
/// # }
/// ```
...
/// Creates a ResNet-50 model without the final classification layer.
///
/// Returns 2048-dimensional features after global average pooling.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::resnet::resnet50_no_final_layer;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = resnet50_no_final_layer(vb)?;
/// # Ok(())
/// # }
/// ```
...
///
/// Uses bottleneck blocks with layer counts `[3, 4, 23, 3]`.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::resnet::resnet101;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = resnet101(1000, vb)?;
/// # Ok(())
/// # }
/// ```
...
/// Creates a ResNet-101 model without the final classification layer.
///
/// Returns 2048-dimensional features after global average pooling.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::resnet::resnet101_no_final_layer;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = resnet101_no_final_layer(vb)?;
/// # Ok(())
/// # }
/// ```
...
///
/// Uses bottleneck blocks with layer counts `[3, 8, 36, 3]`.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::resnet::resnet152;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = resnet152(1000, vb)?;
/// # Ok(())
/// # }
/// ```
...
/// Creates a ResNet-152 model without the final classification layer.
///
/// Returns 2048-dimensional features after global average pooling.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::resnet::resnet152_no_final_layer;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = resnet152_no_final_layer(vb)?;
/// # Ok(())
/// # }
/// ```
