...
//! bounding box).
//!
//! - ⚡ [Interactive Wasm Example](https://huggingface.co/spaces/radames/fuel-segment-anything-wasm)
...
//!   <img src="https://github.com/huggingface/fuel/raw/main/fuel-examples/examples/yolo-v8/assets/bike.jpg" alt="" width="30%">
//!   <img src="https://github.com/huggingface/fuel/raw/main/fuel-examples/examples/segment-anything/assets/single_pt_prompt.jpg" alt="" width="30%">
//!   <img src="https://github.com/huggingface/fuel/raw/main/fuel-examples/examples/segment-anything/assets/two_pt_prompt.jpg" alt="" width="30%">
//! </div>
//!
//!
...
/// Create a linear layer with optional bias using the tracing wrapper.
...
/// 2-D layer normalisation applied along the channel dimension.
#[derive(Debug)]
...
impl LayerNorm2d {
    /// Build `LayerNorm2d` for `num_channels` channels.
...
/// Two-layer MLP feed-forward block used throughout SAM.
#[derive(Debug)]
pub struct MlpBlock {
    lin1: Linear,
    lin2: Linear,
...
impl MlpBlock {
    /// Build an `MlpBlock` projecting `embedding_dim` → `mlp_dim` → `embedding_dim`.
    pub fn new(
        embedding_dim: usize,
        mlp_dim: usize,
        activation: fuel_nn::Activation,
