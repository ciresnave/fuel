...
//!
//! - ⚡ [Interactive Wasm Example](https://huggingface.co/spaces/lmz/fuel-whisper)
...
/// Configuration for a Whisper encoder-decoder model.
...
/// Default floating-point dtype used for Whisper inference.
pub const DTYPE: fuel::DType = fuel::DType::F32;

// Audio parameters.
/// Audio sample rate expected by Whisper (16 kHz).
pub const SAMPLE_RATE: usize = 16000;
/// FFT window size for Whisper mel-spectrogram computation.
pub const N_FFT: usize = 400;
/// Hop length (stride) for Whisper short-time Fourier transform.
pub const HOP_LENGTH: usize = 160;
/// Audio chunk length in seconds that Whisper processes at once.
pub const CHUNK_LENGTH: usize = 30;
/// Number of PCM samples in one 30-second Whisper chunk.
pub const N_SAMPLES: usize = CHUNK_LENGTH * SAMPLE_RATE; // 480000 samples in a 30-second chunk
/// Number of mel-spectrogram frames produced from one Whisper chunk.
