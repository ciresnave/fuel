...
impl FlowMatchEulerDiscreteScheduler {
    /// Creates a new scheduler from config, precomputing the sigma and timestep schedules.
...
/// Maximum image sequence length used to compute the dynamic shift value.
pub const MAX_IMAGE_SEQ_LEN: usize = 4096;
/// Minimum shift value in the dynamic shift formula.
pub const BASE_SHIFT: f64 = 0.5;
/// Maximum shift value in the dynamic shift formula.
