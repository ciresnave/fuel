...
//! ([`crate::models::lazy_blip_vision::BlipVisionModel`]) with the BLIP
//! text decoder ([`crate::models::lazy_blip_text::BlipTextModel`]) into a
...
use crate::models::lazy_blip_text::{BlipTextConfig, BlipTextModel, BlipTextWeights};
use crate::models::lazy_blip_vision::{BlipVisionConfig, BlipVisionModel, BlipVisionWeights};
...
mod tests {
    ...
    fn ln_weights(dim: usize) -> crate::models::lazy_blip_vision::LayerNormWeights {
        crate::models::lazy_blip_vision::LayerNormWeights {
            gain: Arc::from(vec![1.0_f32; dim]),
            bias: Arc::from(vec![0.0_f32; dim]),
        }
    }

    fn ln_weights_text(dim: usize) -> crate::models::lazy_blip_text::LayerNormWeights {
        crate::models::lazy_blip_text::LayerNormWeights {
            gain: Arc::from(vec![1.0_f32; dim]),
            bias: Arc::from(vec![0.0_f32; dim]),
        }
    }
