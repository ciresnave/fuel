...
use crate::models::lazy_mimi_resampler::{ConvDownsample1dModel, ConvTrUpsample1dModel};
...
impl MimiModel {
    ...
    fn downsample(&self) -> ConvDownsample1dModel {
        ConvDownsample1dModel {
            weights: crate::models::lazy_mimi_resampler::ConvDownsample1dWeights {
    ...
    fn upsample(&self) -> ConvTrUpsample1dModel {
        ConvTrUpsample1dModel {
            weights: crate::models::lazy_mimi_resampler::ConvTrUpsample1dWeights {
