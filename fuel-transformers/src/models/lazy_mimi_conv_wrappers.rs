...
use crate::models::lazy_mimi_conv::{LazyPadMode, StreamConv1dState, StreamableConv1dWeights};
use crate::models::lazy_mimi_conv_transpose::{
...
impl ConvDownsample1dWeights {
    ...
    /// (call [`crate::models::lazy_mimi_conv::bake_weight_norm`] first if the
...
impl ConvTrUpsample1dWeights {
    ...
    /// (call [`crate::models::lazy_mimi_conv_transpose::bake_weight_norm_transpose`]
