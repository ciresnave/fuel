...
//!
//! - [`crate::models::lazy_mimi_seanet`] — convolutional encoder/decoder.
//! - [`crate::models::lazy_mimi_transformer`] — streaming transformer
//!   (encoder + decoder).
//! - [`crate::models::lazy_mimi_resampler`] — strided causal conv1d /
//!   transposed conv1d between the SeaNet frame rate and the
//!   user-configured `frame_rate` at the quantizer.
//! - [`crate::models::lazy_mimi_quantization`] — split residual vector
//!   quantizer.
//!
...
//! into the [`crate::models::lazy_mimi::MimiWeights::resampler_stride`].
//!
//! ## Streaming
//!
...
use crate::models::lazy_mimi::{MimiConfig, MimiModel, MimiWeights};
...
impl MimiEncodecModel {
    ...
    pub fn decode_step(
        ...
        let chunk_host = fuel_core::pipelined_bridge::realize_one_as::<u32>(
            codes_chunk.graph_tensor().graph(),
            codes_chunk.graph_tensor().id(),
            &fuel_core::Device::cpu(),
        )
        .map_err(|e| fuel_core::Error::Msg(format!("decode_step: realize codes: {e:?}")))?;
...
mod tests {
    use super::*;
    use crate::models::lazy_encodec::PadMode;
    use crate::models::lazy_mimi_quantization::{
    ...
    use crate::models::lazy_mimi_seanet::{
    ...
    use crate::models::lazy_mimi_transformer::{
