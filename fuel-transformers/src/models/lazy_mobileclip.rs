...
//!
//! Composition wrapper: pairs a [`crate::models::lazy_fastvit::FastVitModel`]
//! image encoder with a [`crate::models::lazy_openclip_text::OpenClipTextModel`]
...
use crate::models::lazy_fastvit::{FastVitConfig, FastVitModel, FastVitWeights};
use crate::models::lazy_openclip_text::{
    OpenClipTextConfig, OpenClipTextModel, OpenClipTextWeights,
};
