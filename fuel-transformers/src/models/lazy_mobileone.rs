...
//!
//! MobileOne is the depthwise-pointwise sibling of [`crate::models::lazy_repvgg`]
...
//! [`crate::models::lazy_repvgg::fuse_repvgg_block`] except for the
...
use fuel_core::lazy::{Tensor, WeightStorage, load_tensor_as_f32};
use fuel_ir::Shape;
use std::sync::Arc;
...
fn mobileone_load_layer(
    ...
    k: usize,
    has_se: bool,
) -> fuel_core::Result<MobileOneLayerWeights> {
    let _ = cfg;
...
/// [`crate::models::lazy_repvgg::fuse_conv_bn_kernel`] (kept local to avoid a
