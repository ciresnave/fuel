...
//!     ([`crate::models::lazy_mixformer::MixFormerModel`]).
//!
...
use crate::models::lazy_mixformer::{MixFormerConfig, MixFormerModel, MixFormerWeights};
#[cfg(test)]
    ...
    fn vision_encode(&self, pixel_values: &Tensor) -> Result<Tensor> {
        ...
        if dims[2] != cfg.image_size || dims[3] != cfg.image_size {
            return Err(fuel_core::Error::Msg(format!(
                "moondream vision: input spatial dims ({}, {}) must equal image_size {}; this \
...
mod tests {
    use super::*;
    use crate::models::lazy_mixformer::{MixFormerActivation, MixFormerLayerWeights};
