...
//! encoder ([`crate::models::lazy_siglip::SiglipVisionModel`]) and an
//! existing lazy language model ([`crate::models::lazy_gemma::GemmaModel`])
...
use crate::models::lazy_gemma::{GemmaConfig, GemmaModel, GemmaWeights};
use crate::models::lazy_siglip::{
...
mod tests {
    ...
    fn tiny_vision_cfg() -> SiglipVisionConfig {
        SiglipVisionConfig {
            ...
            image_size: 8,
            patch_size: 4,
            hidden_activation: crate::models::lazy_siglip::SiglipActivation::GeluPytorchTanh,
            layer_norm_eps: 1e-6,
        }
    }
