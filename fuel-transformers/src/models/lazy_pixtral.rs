...
//!
//! Text decoder is [`crate::models::lazy_mistral::MistralModel`]
...
impl PixtralModel {
    ...
    fn encode_vision(&self, pixel_values: &Tensor) -> Result<Tensor> {
        ...
        pixel_values
            .shape()
            .dims4()
            .map_err(|e| e.context("PixtralModel::encode_vision: pixel_values"))?;
        let batch = dims[0];
...
mod tests {
    use super::*;
    use crate::models::lazy_mistral::MistralConfig;
