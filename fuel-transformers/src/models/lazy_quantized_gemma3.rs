...
//! identical to [`crate::models::lazy_gemma3::Gemma3Model`]; only the weight
...
use crate::models::lazy_gemma3::{Gemma3Config, Gemma3LayerWeights, Gemma3Model, Gemma3Weights};
...
mod tests {
    use super::*;
    use crate::models::lazy_gemma3::GemmaActivation;
