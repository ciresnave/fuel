...
//! path is identical to [`crate::models::lazy_lfm2::LFM2Model`]; only the
...
mod tests {
    use super::*;
    use crate::models::lazy_lfm2::{LFM2AttentionWeights, LFM2BlockType, LFM2ConvWeights};
