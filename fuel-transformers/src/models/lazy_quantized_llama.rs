...
//! lazy-graph API.
//!
//! Wraps [`crate::models::lazy_llama_full::Llama3Model`] — the LLaMA family
...
//! ## Field set
//!
//! [`fuel_core::lazy::LayerWeights`](fuel_core::lazy::LayerWeights) is shared
...
//! [`crate::models::lazy_llama_full::tied_lm_head_from_embeddings`] convention.
