...
//! identical to [`crate::models::lazy_smollm3::SmolLm3Model`]; only the weight
...
use crate::models::lazy_smollm3::{SmolLm3Config, SmolLm3Model, SmolLm3Weights};
#[cfg(test)]
...
impl QuantizedSmolLm3Model {
    ...
    pub fn inner(&self) -> &SmolLm3Model {
        &self.inner
    }
