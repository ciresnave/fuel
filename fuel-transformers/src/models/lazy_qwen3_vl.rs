...
//! wires the already-shipped [`crate::models::lazy_qwen3_vl_vision`] tower and
//! [`crate::models::lazy_qwen3_vl_text`] decoder together with a learned
...
//!    [`crate::models::lazy_qwen3_vl_text::Qwen3VlTextModel::forward_embeds_with_deepstack`].
...
use crate::models::lazy_qwen3_vl_text::{
    MropePos, Qwen3VlTextConfig, Qwen3VlTextModel, Qwen3VlTextWeights,
};
use crate::models::lazy_qwen3_vl_vision::{
...
mod tests {
    ...
    use crate::models::lazy_qwen3_vl_text::Qwen3VlTextLayerExtras;
    use crate::models::lazy_qwen3_vl_vision::{
