...
//!
//! Qwen3-VL extends the Qwen3 decoder (see [`crate::models::lazy_qwen3`]) with
...
//! re-implemented here without disturbing [`crate::models::lazy_qwen3`].
...
/// Qwen3-VL text-side configuration. Mirrors [`crate::models::lazy_qwen3::Qwen3Config`]
