...
//!
//! Phase D specialized port. RWKV v6 extends [`crate::models::lazy_rwkv5`]
...
pub use crate::models::lazy_rwkv5::Rwkv5Config as Rwkv6Config;
...
impl Rwkv6Model {
    ...
    fn time_mix(
        ...
        let stream_offset = |s: usize| -> Result<Tensor> {
...
impl Rwkv6Weights {
    /// Load RWKV-v6 ("Finch") weights from HuggingFace safetensors.
    ...
    pub fn load_from_mmapped(
        ...
        for i in 0..cfg.num_hidden_layers {
            ...
            let attn_time_mix_key = f("time_mix_key")?;
            let attn_time_mix_value = f("time_mix_value")?;
            let attn_time_mix_receptance = f("time_mix_receptance")?;
            let attn_time_mix_gate = f("time_mix_gate")?;
            let attn_time_mix_w1 = f("time_mix_w1")?;
            let attn_time_mix_w2 = f("time_mix_w2")?;
            let attn_time_decay = f("time_decay")?;
            let attn_time_decay_w1 = f("time_decay_w1")?;
            let attn_time_decay_w2 = f("time_decay_w2")?;
            let attn_time_faaaa = f("time_faaaa")?;
