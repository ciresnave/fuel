...
//! # Substrate choice
//!
//! Reuses [`crate::models::lazy_sd_text_encoder::SdTextEncoder`] for both
...
//! Reuses [`crate::models::lazy_t5::T5Model::forward_encoder`] for the
...
#[cfg(test)]
use crate::models::lazy_sd_text_encoder::ClipTextActivation;
use crate::models::lazy_sd_text_encoder::{ClipTextConfig, ClipTextWeights, SdTextEncoder};
use crate::models::lazy_t5::{T5Config, T5Model, T5Weights};
...
impl Sd3TripleClipConfig {
    ...
    fn t5_xxl_config() -> T5Config {
        T5Config {
            ...
            activation: crate::models::lazy_t5::T5Activation::GeluPytorchTanh,
            gated_ffn: true,
...
mod tests {
    use super::*;
    use crate::models::lazy_sd_text_encoder::ClipLayerWeights;
