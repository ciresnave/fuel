...
use fuel_nn::{embedding, linear_b as linear, Embedding, LayerNorm, Linear, Module, VarBuilder};
...
/// Configuration for the GPT-BigCode (StarCoder) model.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::bigcode::Config;
/// let cfg = Config::starcoder_1b();
...
impl Config {
    #[allow(dead_code)]
    /// Return config for the 1B-parameter StarCoder model.
    ///
    /// # Example
    ///
    /// ```
    ...
    #[allow(dead_code)]
    /// Return config for the 3B-parameter StarCoder model.
    ///
    /// # Example
    ///
    /// ```
    /// use fuel_transformers::models::bigcode::Config;
    /// let cfg = Config::starcoder_3b();
    /// assert_eq!(cfg.vocab_size, 49152);
    ...
    #[allow(dead_code)]
    /// Return config for the 7B-parameter StarCoder model.
    ///
    /// # Example
    ///
    /// ```
    /// use fuel_transformers::models::bigcode::Config;
    /// let cfg = Config::starcoder_7b();
    /// assert_eq!(cfg.vocab_size, 49152);
    ...
    #[allow(dead_code)]
    /// Return config for the full 15B StarCoder model.
    ///
    /// # Example
    ///
    /// ```
    /// use fuel_transformers::models::bigcode::Config;
    /// let cfg = Config::starcoder();
    /// assert_eq!(cfg.vocab_size, 49152);
...
impl Attention {
    ...
    fn attn(
        ...
        if query.dtype() != DType::F32 {
            ...
            fuel::bail!("upcasting is not supported {:?}", query.dtype())
        }
...
/// GPT-BigCode (StarCoder) causal language model.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::bigcode::{Config, GPTBigCode};
...
impl GPTBigCode {
    ...
    /// # use fuel_nn::VarBuilder;
    /// # let vb: VarBuilder = unimplemented!();
    /// let model = GPTBigCode::load(vb, Config::starcoder_1b())?;
    ...
    /// Load the model weights from a variable store.
    ///
    /// # Example
    ///
    /// ```no_run
