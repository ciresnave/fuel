...
/// Configuration for ChatGLM / GLM models.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::chatglm::Config;
/// let cfg = Config::glm3_6b();
...
impl Config {
    /// Return config for the ChatGLM3-6B model.
    ///
    /// # Example
    ///
    /// ```
    ...
    /// let cfg = Config::glm3_6b();
    /// assert_eq!(cfg.num_layers, 28);
    /// assert_eq!(cfg.padded_vocab_size, 65024);
    /// ```
    pub fn glm3_6b() -> Self {
        Self {
            num_layers: 28,
...
/// ChatGLM / GLM transformer language model.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::chatglm::{Config, Model};
...
impl Model {
    ...
    ///
    /// ```no_run
    /// # use fuel_transformers::models::chatglm::Model;
