...
/// End-of-sequence token identifier (single or multiple token IDs).
///
/// # Example
///
/// ```
/// use fuel_transformers::models::glm4::EosTokenId;
/// let eos = EosTokenId::Single(151329);
/// ```
#[derive(Debug, Clone)]
pub enum EosTokenId {
    Single(u32),
...
/// Configuration for the GLM-4 model.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::glm4::Config;
...
///
/// ```no_run
/// # use fuel_transformers::models::glm4::{Config, Model};
...
impl Model {
    /// Create a new GLM-4 model from the given configuration and variable store.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// Reset the key-value cache for inference.
    ///
    /// # Example
    ///
    /// ```no_run
