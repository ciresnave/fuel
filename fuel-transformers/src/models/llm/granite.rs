...
/// Rope scaling type for Granite models.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::granite::GraniteRopeType;
/// let t = GraniteRopeType::Default;
/// ```
...
/// Rope scaling configuration for Granite models.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::granite::GraniteRopeConfig;
/// let cfg = GraniteRopeConfig::default();
/// ```
#[derive(Debug, Clone, serde::Deserialize, Default)]
...
/// EOS token(s) for Granite models (single value or a list).
///
/// # Example
///
/// ```
/// use fuel_transformers::models::granite::GraniteEosToks;
/// let t = GraniteEosToks::Single(0u32);
/// ```
...
/// HuggingFace-style Granite configuration (with optional rope scaling).
///
/// # Example
///
/// ```no_run
/// # let cfg: fuel_transformers::models::granite::GraniteConfig = unimplemented!(); // Typically loaded from JSON
/// ```
#[derive(Debug, Clone, serde::Deserialize)]
...
impl GraniteConfig {
    /// Return the effective number of KV heads (default: same as attention heads).
    ///
    /// # Example
    ///
/// ```no_run
    /// # let cfg: fuel_transformers::models::granite::GraniteConfig = unimplemented!();
...
impl GraniteConfig {
    /// Convert into the internal `Config` format.
    ///
    /// # Example
    ///
    /// ```no_run
    /// # use fuel_transformers::models::granite::GraniteConfig;
    /// # let cfg: GraniteConfig = unimplemented!();
...
/// Internal Granite model configuration.
///
/// # Example
///
/// ```no_run
/// # let cfg: fuel_transformers::models::granite::Config = unimplemented!(); // Built via GraniteConfig::into_config
/// ```
#[derive(Debug, Clone)]
pub struct Config {
    pub hidden_size: usize,
...
impl Cache {
    /// Initialise the KV cache with precomputed RoPE freqs.
    ///
    /// # Example
    ///
    /// ```no_run
...
/// Granite (Llama-based IBM) language model.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::granite::{Config, Granite};
...
impl Granite {
    ...
    ///
    /// ```no_run
    /// # use fuel_transformers::models::granite::{Cache, Config, Granite};
    /// # use fuel::{DType, Device, DType as D, Tensor};
    /// # use fuel_nn::VarBuilder;
    /// # let vb: VarBuilder = unimplemented!();
    /// # let cfg: Config = unimplemented!();
    /// let model = Granite::load(vb, &cfg)?;
    ...
    /// Load the model from a variable store.
    ///
    /// # Example
    ///
    /// ```no_run
