...
use fuel::{DType, Device, IndexOp, Result, Tensor, D};
use fuel_nn::{embedding, Embedding, Module, VarBuilder};
use std::{collections::HashMap, f32::consts::PI};

/// Default maximum sequence length for GraniteMoeHybrid models.
pub const DEFAULT_MAX_SEQ_LEN: usize = 4096;

/// RoPE scaling type for GraniteMoeHybrid models.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::granitemoehybrid::GraniteMoeHybridRopeType;
/// let t = GraniteMoeHybridRopeType::Default;
/// ```
...
/// RoPE scaling parameters for GraniteMoeHybrid models.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::granitemoehybrid::GraniteMoeHybridRopeConfig;
/// let cfg = GraniteMoeHybridRopeConfig::default();
/// ```
#[derive(Debug, Clone, serde::Deserialize, Default)]
...
/// Serializable configuration for GraniteMoeHybrid models.
///
/// # Example
///
/// ```no_run
/// # let cfg: fuel_transformers::models::granitemoehybrid::GraniteMoeHybridConfig = unimplemented!(); // Typically loaded from JSON
/// ```
...
impl GraniteMoeHybridConfig {
    /// Return the number of key-value heads (defaults to `num_attention_heads`).
    ///
    /// # Example
    ///
/// ```no_run
    /// # let cfg: fuel_transformers::models::granitemoehybrid::GraniteMoeHybridConfig = unimplemented!();
    /// let _kv_heads = cfg.num_key_value_heads();
    /// ```
...
/// Layer type selector for hybrid attention/Mamba layers.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::granitemoehybrid::GraniteMoeHybridLayerType;
/// let t = GraniteMoeHybridLayerType::Attention;
/// ```
#[derive(Debug, Clone, serde::Deserialize, Default)]
...
impl GraniteMoeHybridConfig {
    /// Convert to the internal (resolved) config, suitable for model construction.
    ///
    /// # Example
    ///
/// ```no_run
    /// # let cfg: fuel_transformers::models::granitemoehybrid::GraniteMoeHybridConfig = unimplemented!();
    /// let internal = cfg.into_config(false);
    /// ```
...
/// Resolved internal configuration for GraniteMoeHybrid models.
///
/// # Example
///
/// ```no_run
/// # let cfg: fuel_transformers::models::granitemoehybrid::GraniteMoeHybridInternalConfig = unimplemented!(); // Built via GraniteMoeHybridConfig::into_config
/// ```
#[derive(Debug, Clone)]
...
/// KV-cache and RoPE state for GraniteMoeHybrid inference.
///
/// # Example
///
/// ```no_run
...
impl GraniteMoeHybridCache {
    /// Create a new cache for GraniteMoeHybrid inference.
    ///
    /// # Example
    ///
    /// ```no_run
...
impl MultiLayerPercepton {
    fn forward(&self, x: &Tensor) -> Result<Tensor> {
        ...
        let gated = (fuel_nn::ops::silu(left)? * right)?;
...
/// The GraniteMoeHybrid model combining attention and Mamba layers.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::granitemoehybrid::{GraniteMoeHybrid, GraniteMoeHybridInternalConfig};
...
impl GraniteMoeHybrid {
    /// Run the forward pass and return logits over the vocabulary.
    ///
    /// # Example
    ///
    /// ```no_run
    /// # use fuel_transformers::models::granitemoehybrid::{GraniteMoeHybrid, GraniteMoeHybridCache, GraniteMoeHybridInternalConfig};
    ...
    /// Load GraniteMoeHybrid from a variable store.
    ///
    /// # Example
    ///
    /// ```no_run
