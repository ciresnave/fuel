...
use fuel_nn::{kv_cache::KvCache, Module, VarBuilder};
...
/// Configuration for Helium language models.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::helium::Config;
/// let cfg = Config::config_2b(false);
/// assert_eq!(cfg.vocab_size, 48000);
...
impl Config {
    /// Return config for the 2B-parameter Helium model.
    ///
    /// # Example
    ///
    /// ```
    ...
    pub fn config_2b(use_flash_attn: bool) -> Self {
        Self {
            ...
            eos_token_id: 2,
            head_dim: 128,
            hidden_act: fuel_nn::Activation::Silu,
            hidden_size: 2560,
...
/// Helium transformer language model.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::helium::{Model, Config};
...
impl Model {
    ...
    /// Return a reference to the token embedding table.
    ///
    /// # Example
    ///
    /// ```no_run
    /// use fuel_transformers::models::helium::Model;
    /// use fuel_nn::Embedding;
    /// # let model: Model = unimplemented!();
    /// let emb: &Embedding = model.embed_tokens();
    /// ```
