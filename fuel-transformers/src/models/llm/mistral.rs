...
fn default_hidden_act() -> fuel_nn::Activation {
...
impl Config {
    ...
    /// # Example
    /// ```
    /// use fuel_transformers::models::mistral::Config;
...
impl Model {
    ...
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::mistral::{Config, Model};
    ...
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::mistral::Model;
    /// # fn main() {
