...
/// See: <https://github.com/huggingface/transformers/blob/1a585c1222a56bcaecc070966d558d4a9d862e83/src/transformers/models/mixtral/configuration_mixtral.py#L113>
///
/// # Example
/// ```no_run
/// use fuel_transformers::models::mixtral::Config;
/// let cfg = Config::v0_1_8x7b(false);
/// ```
...
/// The Mixtral mixture-of-experts causal language model.
///
/// Implements the Mixtral-8x7B architecture with sparse top-k MoE layers,
/// grouped-query attention, and a sliding-window attention mask.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::mixtral::{Config, Model};
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// let model = Model::new(&Config::v0_1_8x7b(false), vb)?;
/// # Ok(())
/// # }
/// ```
#[derive(Debug, Clone)]
...
impl Model {
    /// Construct a new Mixtral model, loading weights from `vb`.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::mixtral::{Config, Model};
    ...
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::mixtral::Model;
