...
use fuel_nn::{kv_cache::KvCache, layer_norm, LayerNorm, VarBuilder};
...
///
/// ```
/// use fuel_transformers::models::mpt::Config;
...
///
/// ```no_run
/// use fuel_transformers::models::mpt::{Model, Config};
...
impl Model {
    ...
    pub fn new(cfg: &Config, vb: VarBuilder) -> Result<Self> {
        ...
        let norm_f = fuel_nn::layer_norm(cfg.d_model, ln_cfg, vb.pp("norm_f"))?;
        Ok(Self {
            wte,
            blocks,
            norm_f,
