...
use fuel_nn::{kv_cache::KvCache, linear_b, linear_no_bias, Activation, LayerNorm, Linear, VarBuilder};
...
///
/// ```no_run
/// use fuel_transformers::models::olmo::{Model, Config};
...
/// OLMo transformer language model.
///
/// # Example
///
/// ```no_run
...
impl Model {
    /// Create a new OLMo model from `cfg`.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    ///
    /// ```no_run
    /// use fuel_transformers::models::olmo::Model;
