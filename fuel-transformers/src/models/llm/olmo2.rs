...
use fuel_nn::{kv_cache::KvCache, linear_b, linear_no_bias, rms_norm, Activation, Linear, RmsNorm, VarBuilder};
use std::collections::HashMap;
use std::sync::Arc;

/// Configuration for the OLMo-2 language model.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::olmo2::{Model, Config};
...
impl Model {
    /// Create a new OLMo-2 model from config and variable store.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// Run the forward pass and return logits for the last position.
    ///
    /// # Example
    ///
    /// ```no_run
    /// use fuel_transformers::models::olmo2::Model;
