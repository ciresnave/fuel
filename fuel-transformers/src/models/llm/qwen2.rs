...
/// Qwen2 transformer base model (without the LM head).
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::qwen2::{Config, Model};
...
impl Model {
    /// Create a new Qwen2 base model from `cfg`.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::qwen2::{Config, Model};
    ...
    /// * `seqlen_offset` - KV-cache offset (number of previously processed tokens).
    ...
    /// Clear the KV cache.
    ///
    /// Call this between independent generation requests.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::qwen2::Model;
...
/// Qwen2 language model with a causal LM head.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::qwen2::{Config, ModelForCausalLM};
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let cfg: Config = unimplemented!();
/// # let vb: VarBuilder = unimplemented!();
...
impl ModelForCausalLM {
    /// Create a new causal LM from `cfg`.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::qwen2::{Config, ModelForCausalLM};
    ...
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::qwen2::ModelForCausalLM;
    /// # use fuel::{Device, DType, Tensor};
    /// # fn main() -> fuel::Result<()> {
