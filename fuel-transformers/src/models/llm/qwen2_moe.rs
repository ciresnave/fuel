...
///
/// ```no_run
/// use fuel_transformers::models::qwen2_moe::{Model, Config};
...
impl Module for SparseMoeBlock {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        ...
        let shared_expert_output = shared_expert_output.broadcast_mul(&fuel_nn::ops::sigmoid(
...
/// Qwen2-MoE transformer language model.
///
/// # Example
///
/// ```no_run
...
impl Model {
    ...
    ///
    /// ```no_run
    /// use fuel_transformers::models::qwen2_moe::Model;
