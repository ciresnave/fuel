...
use fuel_nn::{kv_cache::ConcatKvCache, Activation, VarBuilder};
use std::sync::Arc;
...
impl Qwen3Attention {
    pub(crate) fn new(
        ...
        if cfg.use_sliding_window {
            fuel::bail!("sliding window is not supported")
        }
...
/// Qwen3 transformer base model.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::qwen3::{Config, Model};
...
impl Model {
    ...
    /// Run a forward pass returning hidden states.
    ///
    /// # Arguments
    ...
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::qwen3::Model;
...
/// Qwen3 language model with a causal LM head.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::qwen3::{Config, ModelForCausalLM};
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let cfg: Config = unimplemented!();
/// # let vb: VarBuilder = unimplemented!();
...
impl ModelForCausalLM {
    ...
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::qwen3::ModelForCausalLM;
    /// # use fuel::{Device, DType, Tensor};
    /// # fn main() -> fuel::Result<()> {
