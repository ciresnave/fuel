...
/// Configuration for the Qwen3-MoE language model.
///
/// # Example
///
/// ```no_run
/// # let cfg: fuel_transformers::models::qwen3_moe::Config = unimplemented!(); // Typically loaded from JSON
/// ```
...
impl Module for Qwen3SparseMoeBlock {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        ...
        let routing_weights = fuel_nn::ops::softmax_last_dim(&router_logits)?;
...
/// The Qwen3-MoE base transformer model.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::qwen3_moe::{Config, Model};
...
impl Model {
    /// Create a new Qwen3-MoE model from config and variable store.
    ///
    /// # Example
    ///
    /// ```no_run
...
/// The Qwen3-MoE model with a causal language modelling head.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::qwen3_moe::{Config, ModelForCausalLM};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
...
impl ModelForCausalLM {
    ...
    /// Run the forward pass and return logits over the vocabulary for the last position.
    ///
    /// # Example
    ///
    /// ```no_run
