...
use fuel_nn::{kv_cache::KvCache, layer_norm, linear_b, LayerNorm, Linear, VarBuilder};
use std::collections::HashMap;
use std::sync::Arc;

/// StarCoder 2 model configuration.
///
...
///
/// ```no_run
/// use fuel_transformers::models::starcoder2::{Model, Config};
...
/// StarCoder 2 transformer language model.
///
/// # Example
///
/// ```no_run
...
impl Model {
    /// Create a new StarCoder 2 model from `cfg`.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    pub fn new(cfg: &Config, vb: VarBuilder) -> Result<Self> {
        ...
        let lm_head = fuel_nn::Linear::new(embed_tokens.embeddings().clone(), None);
        Ok(Self {
            embed_tokens,
            layers,
            norm,
    ...
    ///
    /// ```no_run
    /// use fuel_transformers::models::starcoder2::Model;
