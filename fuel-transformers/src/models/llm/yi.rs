...
//!
//! This fuel implementation uses a pre-trained Yi decoder-only large language model for inference.
...
/// Configuration for the Yi language model.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::yi::Config;
/// let cfg = Config::config_6b();
/// // Retrieve config via named constructor.
/// let cfg34 = Config::config_34b();
/// ```
...
impl Config {
    /// Return the default configuration for the Yi 6B model.
    ///
    /// # Example
    ///
    /// ```
    ...
    /// Return the default configuration for the Yi 34B model.
    ///
    /// # Example
    ///
    /// ```
    /// use fuel_transformers::models::yi::Config;
    /// let cfg = Config::config_34b();
    /// ```
...
/// The Yi causal language model.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::yi::{Model, Config};
...
impl Model {
    /// Create a new Yi model from config and variable store.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// Run the forward pass and return next-token logits at the last sequence position.
    ///
    /// # Example
    ///
    /// ```no_run
    /// use fuel_transformers::models::yi::Model;
