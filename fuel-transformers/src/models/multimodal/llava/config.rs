...
/// LLaVA model configuration (original liuhaotian format).
...
impl LLaVAConfig {
    /// Convert to a Llama `Config` for the language model backbone.
...
/// Hugging Face LLaVA text encoder configuration.
#[derive(Serialize, Deserialize, Debug, Clone)]
...
/// Hugging Face LLaVA vision encoder configuration.
#[derive(Serialize, Deserialize, Debug, Clone)]
...
/// Combined HF LLaVA configuration (text + vision).
#[derive(Serialize, Deserialize, Debug, Clone)]
...
/// Generation hyperparameters for LLaVA inference.
#[derive(Serialize, Deserialize, Debug, Clone)]
...
/// Image preprocessing configuration for LLaVA.
#[derive(Serialize, Deserialize, Debug, Clone)]
