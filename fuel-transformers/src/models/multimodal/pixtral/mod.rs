...
//!
//! <div align=center>
//!   <img src="https://github.com/huggingface/fuel/raw/main/fuel-examples/examples/flux/assets/flux-robot.jpg" alt="" width=320>
//! </div>
//!
//! ```bash
...
//!    --features cuda \
//!    --example pixtral -- \
//!    --image fuel-examples/examples/flux/assets/flux-robot.jpg
//! ```
//!
//! ```txt
//! Describe the image.
