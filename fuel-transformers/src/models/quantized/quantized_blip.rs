...
use fuel_nn::{Conv2d, Conv2dConfig, LayerNorm};
...
/// Quantised BLIP vision encoder (patch embeddings + transformer + layer norm).
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_blip::{BlipForConditionalGeneration, Config, VisionModel};
/// use fuel_transformers::models::quantized_blip::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
/// let model = BlipForConditionalGeneration::new(&cfg, vb)?;
/// let enc: &VisionModel = model.vision_model();
/// # Ok::<_, fuel::Error>(())
/// ```
#[derive(Debug, Clone)]
...
/// Quantised BLIP image-captioning model combining a vision encoder with a text decoder.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_blip::{BlipForConditionalGeneration, Config};
/// use fuel_transformers::models::quantized_blip::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
/// let model = BlipForConditionalGeneration::new(&cfg, vb)?;
...
impl BlipForConditionalGeneration {
    /// Load the BLIP model from a `VarBuilder` and config.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// Return a reference to the vision encoder.
    ///
    /// # Example
    ///
    /// ```no_run
    /// use fuel_transformers::models::quantized_blip::{BlipForConditionalGeneration, VisionModel};
    /// # let model: BlipForConditionalGeneration = unimplemented!();
    /// let enc: &VisionModel = model.vision_model();
    /// ```
    ...
    /// Return a mutable reference to the text decoder.
    ///
    /// # Example
    ///
    /// ```no_run
    /// use fuel_transformers::models::quantized_blip::BlipForConditionalGeneration;
    /// use fuel_transformers::models::quantized_blip_text::TextLMHeadModel;
    /// # let mut model: BlipForConditionalGeneration = unimplemented!();
    /// let decoder: &mut TextLMHeadModel = model.text_decoder();
    /// ```
    pub fn text_decoder(&mut self) -> &mut blip_text::TextLMHeadModel {
        &mut self.text_decoder
    }
    /// Reset the KV cache inside the text decoder.
    ///
    /// # Example
    ///
    /// ```no_run
