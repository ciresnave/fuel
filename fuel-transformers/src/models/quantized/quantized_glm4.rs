...
use fuel_nn::{kv_cache::KvCache, Activation, Embedding, Module};
...
/// GGUF-quantised GLM-4 model weights for inference.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_glm4::ModelWeights;
...
impl ModelWeights {
    /// Load quantised GLM-4 weights from a GGUF file.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::quantized_glm4::ModelWeights;
