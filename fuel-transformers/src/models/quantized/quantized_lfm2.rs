...
use fuel_nn::{Conv1d, Conv1dConfig, Embedding, Module};
...
impl Module for Mlp {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        ...
        self.w2.forward(&(fuel_nn::ops::silu(&w1)? * w3)?)
    }
}
...
/// GGUF-quantised LFM-2 (Liquid Foundation Model) weights for inference.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::quantized_lfm2::ModelWeights;
/// # use fuel::Device;
/// # fn main() -> fuel::Result<()> {
...
impl ModelWeights {
    /// Load quantised LFM-2 weights from a GGUF file.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::quantized_lfm2::ModelWeights;
