...
use fuel::{DType, IndexOp, Module, Result, Tensor, D};
...
///
/// ```no_run
/// use fuel_transformers::models::quantized_llama2_c::{QLlama, Config};
/// use fuel_transformers::models::quantized_llama2_c::VarBuilder;
/// use fuel::Device;
...
impl QLlama {
    ...
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::quantized_llama2_c::{QLlama, Cache};
    ...
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::quantized_llama2_c::QLlama;
    /// # use fuel_transformers::models::quantized_llama2_c::VarBuilder;
    /// # fn main() -> fuel::Result<()> {
    /// # let vb: VarBuilder = unimplemented!();
    /// # let cfg: fuel_transformers::models::llama2_c::Config = unimplemented!();
    /// let model = QLlama::load(vb, cfg)?;
    /// # Ok(())
    /// # }
    /// ```
