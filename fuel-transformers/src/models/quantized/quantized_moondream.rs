...
struct VitBlock {
    attn: Attention,
    mlp: Mlp,
    norm1: fuel_nn::LayerNorm,
    norm2: fuel_nn::LayerNorm,
}
...
/// Quantised ViT image encoder backbone for Moondream.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_moondream::{VisionEncoder};
/// use fuel_transformers::models::moondream::VisionConfig;
/// use fuel_transformers::models::quantized_mixformer::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: VisionConfig = unimplemented!();
...
/// Vision encoder that patches and projects an image into token embeddings for Moondream.
///
/// # Example
///
/// ```no_run
...
impl VisionEncoder {
    /// Load the vision encoder from a `VarBuilder` and vision config.
    ///
    /// # Example
    ///
    /// ```no_run
...
/// Quantised Moondream vision-language model combining a vision encoder and a Phi text model.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_moondream::Model;
/// use fuel_transformers::models::moondream::Config;
/// use fuel_transformers::models::quantized_mixformer::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
...
impl Model {
    /// Load the combined vision-language model from a `VarBuilder` and config.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    ///
    /// ```no_run
    /// use fuel_transformers::models::quantized_moondream::{Model, VisionEncoder};
    /// # let model: Model = unimplemented!();
    /// let enc: &VisionEncoder = model.vision_encoder();
    /// ```
    pub fn vision_encoder(&self) -> &VisionEncoder {
        &self.vision_encoder
    }

    /// Return a mutable reference to the Phi text model.
    ///
    /// # Example
    ///
    /// ```no_run
