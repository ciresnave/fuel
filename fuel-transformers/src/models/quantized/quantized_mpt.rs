...
/// Quantised MPT causal language model.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_mpt::{Model, Config};
/// use fuel_transformers::models::quantized_mpt::VarBuilder;
/// use fuel::Device;
...
impl Model {
    /// Construct a quantised MPT model from config and a quantised variable store.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::quantized_mpt::Model;
    /// # use fuel_transformers::models::quantized_mpt::VarBuilder;
    /// # fn main() -> fuel::Result<()> {
    /// # let vb: VarBuilder = unimplemented!();
    /// # let cfg: fuel_transformers::models::mpt::Config = unimplemented!();
    /// let model = Model::new(&cfg, vb)?;
    /// # Ok(())
    /// # }
    /// ```
