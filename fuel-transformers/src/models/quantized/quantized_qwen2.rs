...
use crate::{quantized_nn::RmsNorm, utils::repeat_kv, utils::masked_fill};
use fuel::{
...
impl LayerWeights {
    fn apply_rotary_emb(&self, x: &Tensor, index_pos: usize) -> Result<Tensor> {
        ...
        fuel_nn::rotary_emb::rope(&x.contiguous()?, &cos, &sin)
    }
...
/// GGUF-quantised Qwen-2 model weights for inference.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::quantized_qwen2::ModelWeights;
/// # use fuel::Device;
/// # fn main() -> fuel::Result<()> {
...
impl ModelWeights {
    /// Load quantised Qwen-2 weights from a GGUF file.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::quantized_qwen2::ModelWeights;
