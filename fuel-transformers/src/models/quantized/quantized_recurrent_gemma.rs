...
impl RecurrentBlock {
    fn new(cfg: &Config, vb: VarBuilder) -> Result<Self> {
        ...
        let conv_1d = {
            ...
            let config = fuel_nn::Conv1dConfig {
                groups: lru_width,
                padding: cfg.conv1d_width - 1,
                ..Default::default()
            };
            fuel_nn::Conv1d::new(ws, Some(bs), config)
        };
...
/// Quantised RecurrentGemma causal language model.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_recurrent_gemma::Model;
/// use fuel_transformers::models::recurrent_gemma::Config;
/// use fuel_transformers::models::quantized_recurrent_gemma::VarBuilder;
...
impl Model {
    /// Construct a quantised RecurrentGemma model from config and a quantised variable store.
    ///
    /// # Example
    ///
    /// ```no_run
