...
use crate::quantized_nn::{Embedding, Linear, layer_norm, linear_no_bias as linear};
pub use crate::quantized_var_builder::VarBuilder;
use fuel::{IndexOp, Result, Tensor};
use fuel_nn::{GroupNorm, LayerNorm, Module};
...
/// Quantised RWKV-v5 language model.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_rwkv_v5::{Model, Config, State};
/// use fuel_transformers::models::quantized_rwkv_v5::VarBuilder;
...
impl Model {
    /// Construct a quantised RWKV-v5 model from config and a quantised variable store.
    ///
    /// # Example
    ///
    /// ```no_run
    /// use fuel_transformers::models::quantized_rwkv_v5::{Model, Config};
    /// use fuel_transformers::models::quantized_rwkv_v5::VarBuilder;
    /// # let vb: VarBuilder = unimplemented!();
    /// # let cfg: Config = unimplemented!();
    /// let model = Model::new(&cfg, vb)?;
    ...
    /// Run a forward pass given token ids; updates `state` in-place.
    ///
    /// # Example
    ///
    /// ```no_run
    /// use fuel_transformers::models::quantized_rwkv_v5::{Model, State, Config};
