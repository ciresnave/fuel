...
impl SelfAttention {
    ...
    pub fn forward(&self, xs: &Tensor, state: &mut State) -> Result<Tensor> {
        ...
        let (receptance, key, value, gate, w) = {
            ...
            let gate = fuel_nn::ops::silu(&self.gate.forward(&xg)?)?;
...
/// Quantised RWKV-v6 language model.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_rwkv_v6::{Model, Config, State};
/// use fuel_transformers::models::quantized_rwkv_v6::VarBuilder;
...
impl Model {
    /// Construct a quantised RWKV-v6 model from config and a quantised variable store.
    ///
    /// # Example
    ///
    /// ```no_run
    /// use fuel_transformers::models::quantized_rwkv_v6::{Model, Config};
    /// use fuel_transformers::models::quantized_rwkv_v6::VarBuilder;
    /// # let vb: VarBuilder = unimplemented!();
    /// # let cfg: Config = unimplemented!();
    /// let model = Model::new(&cfg, vb)?;
