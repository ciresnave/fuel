...
/// Configuration for GGUF-quantised T5 encoder and encoder-decoder models.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::quantized_t5::Config;
...
/// GGUF-quantised T5 encoder-only model for embedding and classification tasks.
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_t5::{T5EncoderModel, Config};
/// use fuel_transformers::models::quantized_t5::VarBuilder;
/// use fuel::Device;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
/// let model = T5EncoderModel::load(vb, &cfg)?;
/// # Ok::<_, fuel::Error>(())
/// ```
#[derive(Debug, Clone)]
...
impl T5EncoderModel {
    /// Load the encoder from a `VarBuilder` and config.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// Run the encoder forward pass, returning sequence hidden states.
    ///
    /// # Example
    ///
    /// ```no_run
...
/// GGUF-quantised T5 encoder-decoder model for conditional generation (e.g., translation, summarisation).
///
/// # Example
///
/// ```no_run
/// use fuel_transformers::models::quantized_t5::{T5ForConditionalGeneration, Config};
/// use fuel_transformers::models::quantized_t5::VarBuilder;
/// use fuel::Device;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!(); // cfg.is_encoder_decoder must be true
/// let model = T5ForConditionalGeneration::load(vb, &cfg)?;
/// # Ok::<_, fuel::Error>(())
/// ```
#[derive(Debug, Clone)]
...
impl T5ForConditionalGeneration {
    /// Load the encoder-decoder model from a `VarBuilder` and config.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// Run the encoder over `input_ids`, returning encoder hidden states.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// Run one decoder step and return next-token logits.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// Run a full encoder-decoder forward pass, returning next-token logits.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// Reset the KV caches in both the encoder and decoder stacks.
    ///
    /// # Example
    ///
    /// ```no_run
