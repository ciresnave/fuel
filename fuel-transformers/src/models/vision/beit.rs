...
/// # Example
/// ```no_run
/// # use fuel_transformers::models::beit::BeitVisionTransformer;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
/// // ViT-Base/16: depth=12, embed_dim=768, heads=12
/// let model = BeitVisionTransformer::new(vb, 12, 768, 12)?;
/// # Ok(())
/// # }
/// ```
#[derive(Debug)]
...
impl BeitVisionTransformer {
    /// Construct a BEiT ViT with the given depth, embedding dimension, and head count.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::beit::BeitVisionTransformer;
    ...
    /// # fn main() -> fuel::Result<()> {
    /// # let vb: VarBuilder = unimplemented!();
    /// let model = BeitVisionTransformer::new(vb, 12, 768, 12)?; // ViT-Base
    /// # Ok(())
    /// # }
    /// ```
...
/// Load a BEiT ViT-Base/16 model.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::beit::vit_base;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
...
/// Load a BEiT ViT-Large/16 model.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::beit::vit_large;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
