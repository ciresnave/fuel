...
/// Configuration for a Depth Anything V2 model.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::depth_anything_v2::DepthAnythingV2Config;
/// let cfg = DepthAnythingV2Config::vit_small();
/// ```
...
impl DepthAnythingV2Config {
    ...
    /// ```
    /// use fuel_transformers::models::depth_anything_v2::DepthAnythingV2Config;
    /// let cfg = DepthAnythingV2Config::new([48, 96, 192, 384], 384, 64, false, false, vec![2, 5, 8, 11], 518, 37);
    /// ```
    ...
    /// Pre-built configuration for the ViT-Small DINOv2 backbone (embed_dim=384).
    ///
    /// # Example
    ///
    /// ```
    ...
    /// Pre-built configuration for the ViT-Base DINOv2 backbone (embed_dim=768).
    ///
    /// # Example
    ///
    /// ```
    /// use fuel_transformers::models::depth_anything_v2::DepthAnythingV2Config;
    /// let cfg = DepthAnythingV2Config::vit_base();
    /// ```
    ...
    /// Pre-built configuration for the ViT-Large DINOv2 backbone (embed_dim=1024).
    ///
    /// # Example
    ///
    /// ```
    /// use fuel_transformers::models::depth_anything_v2::DepthAnythingV2Config;
    /// let cfg = DepthAnythingV2Config::vit_large();
    /// ```
    ...
    /// Pre-built configuration for the ViT-Giant DINOv2 backbone (embed_dim=1536).
    ///
    /// # Example
    ///
    /// ```
    /// use fuel_transformers::models::depth_anything_v2::DepthAnythingV2Config;
    /// let cfg = DepthAnythingV2Config::vit_giant();
    /// ```
...
/// Residual convolution unit used inside [`FeatureFusionBlock`].
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::depth_anything_v2::{DepthAnythingV2Config, ResidualConvUnit};
/// # use fuel_nn::{Activation, VarBuilder};
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = DepthAnythingV2Config::vit_small();
/// let unit = ResidualConvUnit::new(&cfg, Activation::Relu, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
...
impl ResidualConvUnit {
    /// Create a new residual convolution unit from `conf`.
    ///
    /// # Example
    ///
    /// ```no_run
...
/// Feature fusion block that fuses two feature maps and upsamples the result.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::depth_anything_v2::{DepthAnythingV2Config, FeatureFusionBlock};
/// # use fuel_nn::{Activation, VarBuilder};
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = DepthAnythingV2Config::vit_small();
/// let block = FeatureFusionBlock::new(&cfg, 37, Activation::Relu, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
...
impl FeatureFusionBlock {
    /// Create a new feature fusion block.
    ///
    /// # Example
    ///
    /// ```no_run
...
/// Scratch network that processes multi-scale features into a depth map.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::depth_anything_v2::{DepthAnythingV2Config, Scratch};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = DepthAnythingV2Config::vit_small();
/// let scratch = Scratch::new(&cfg, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
pub struct Scratch {
    layer1_rn: Conv2d,
...
impl Scratch {
    /// Create a new `Scratch` network from `conf`.
    ///
    /// # Example
    ///
    /// ```no_run
...
/// DPT head that decodes DINOv2 patch token sequences into a dense depth map.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::depth_anything_v2::{DepthAnythingV2Config, DPTHead};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = DepthAnythingV2Config::vit_small();
/// let head = DPTHead::new(&cfg, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
pub struct DPTHead {
...
impl DPTHead {
    /// Create a new DPT head from `conf`.
    ///
    /// # Example
    ///
    /// ```no_run
...
/// Depth Anything V2 model combining a DINOv2 vision transformer with a DPT depth head.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::depth_anything_v2::{DepthAnythingV2Config, DepthAnythingV2};
/// # use fuel_transformers::models::dinov2::DinoVisionTransformer;
/// # use fuel_nn::VarBuilder;
/// # use std::sync::Arc;
/// # let vb: VarBuilder = unimplemented!();
/// # let pretrained: Arc<DinoVisionTransformer> = unimplemented!();
/// let cfg = DepthAnythingV2Config::vit_small();
/// let model = DepthAnythingV2::new(pretrained, cfg, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
...
impl DepthAnythingV2 {
    /// Create a new `DepthAnythingV2` from a pre-trained DINOv2 encoder, `conf`, and a variable store.
    ///
    /// # Example
    ///
    /// ```no_run
