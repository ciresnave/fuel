...
impl Module for Attention {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        ...
        let attn = fuel_nn::ops::softmax(&q.matmul(&k.t()?)?, D::Minus1)?;
...
/// // ViT-Small/14: depth=12, embed_dim=384, heads=6
...
impl DinoVisionTransformer {
    /// Construct a DINOv2 ViT with the given depth, embedding dimension, and head count.
    ///
    /// # Example
    /// ```no_run
    /// # use fuel_transformers::models::dinov2::DinoVisionTransformer;
    ...
    /// # fn main() -> fuel::Result<()> {
    /// # let vb: VarBuilder = unimplemented!();
    /// let model = DinoVisionTransformer::new(vb, 12, 384, 6)?; // ViT-Small
    /// # Ok(())
    /// # }
    /// ```
    ...
    /// # fn main() -> fuel::Result<()> {
    /// # let model: DinoVisionTransformer = unimplemented!();
...
/// Load a DINOv2 ViT-Small/14 model.
///
/// # Example
/// ```no_run
/// # use fuel_transformers::models::dinov2::vit_small;
/// # use fuel_nn::VarBuilder;
/// # fn main() -> fuel::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
