...
//! # see fuel/examples/dinov2reg4 for full code.
//!
//! # Perform inference
//! cargo run \
//!   --example dinov2reg4 \
...
/// DINOv2 vision transformer with register tokens.
#[derive(Debug)]
...
impl DinoVisionTransformer {
    /// Create a new DINOv2 vision transformer with register tokens.
...
/// Build a ViT-Small/14 DINOv2 model with register tokens.
pub fn vit_small(vb: VarBuilder) -> Result<DinoVisionTransformer> {
    DinoVisionTransformer::new(vb, 12, 384, 6)
}

/// Build a ViT-Base/14 DINOv2 model with register tokens.
