...
use fuel::{Result, D};
use fuel_nn::{conv2d, layer_norm, linear, ops::softmax, Conv2dConfig, Func, VarBuilder};
...
///
/// ```
/// use fuel_transformers::models::hiera::Config;
/// let cfg = Config::tiny();
/// ```
...
impl Config {
    ...
    /// Hiera-Base+ (69 M params, wider channels).
    ///
    /// # Example
    ///
    /// ```
    /// use fuel_transformers::models::hiera::Config;
    /// let cfg = Config::base_plus();
    /// ```
...
/// Build a Hiera model with a classification head.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::hiera::{hiera, Config};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::tiny();
/// let model = hiera(&cfg, 1000, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
...
/// Build a Hiera model without the final classification layer.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::hiera::{hiera_no_final_layer, Config};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::tiny();
/// let model = hiera_no_final_layer(&cfg, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
