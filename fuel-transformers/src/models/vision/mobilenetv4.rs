...
/// MobileNet-v4 model configuration.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::mobilenetv4::Config;
...
#[rustfmt::skip]
impl Config {
    /// MobileNetV4-Conv-Small (3.8 M params).
    ///
    /// # Example
    ///
    /// ```
    ...
    /// MobileNetV4-Conv-Medium (9.7 M params).
    ///
    /// # Example
    ///
    /// ```
    ...
    /// MobileNetV4-Hybrid-Medium (11.1 M params, convolutions + attention).
    ///
    /// # Example
    ///
    /// ```
    /// use fuel_transformers::models::mobilenetv4::Config;
    /// let cfg = Config::hybrid_medium();
    /// ```
    ...
    /// MobileNetV4-Conv-Large (32.6 M params).
    ///
    /// # Example
    ///
    /// ```
    ...
    /// MobileNetV4-Hybrid-Large (37.7 M params, convolutions + attention, GELU activations).
    ///
    /// # Example
    ///
    /// ```
    /// use fuel_transformers::models::mobilenetv4::Config;
    /// let cfg = Config::hybrid_large();
    /// ```
...
/// Build a MobileNetV4 model with a classification head.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::mobilenetv4::{mobilenetv4, Config};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::small();
/// let model = mobilenetv4(&cfg, 1000, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
...
/// Build a MobileNetV4 model without the final classification layer.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::mobilenetv4::{mobilenetv4_no_final_layer, Config};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::small();
/// let model = mobilenetv4_no_final_layer(&cfg, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
