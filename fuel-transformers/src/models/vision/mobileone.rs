//! # MobileOne
//!
//! MobileOne inference implementation based on timm and fuel-repvgg
//!
...
#[derive(Clone)]
/// MobileOne model configuration.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::mobileone::Config;
/// let cfg = Config::s0();
/// ```
pub struct Config {
...
impl Config {
    /// MobileOne-S0 (5.3 M params, fastest).
    ///
    /// # Example
    ///
    /// ```
    ...
    /// MobileOne-S4 (14.8 M params, most accurate; uses SE blocks).
    ///
    /// # Example
    ///
    /// ```
...
/// Build a MobileOne model with a classification head.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::mobileone::{mobileone, Config};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::s0();
/// let model = mobileone(&cfg, 1000, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
...
/// Build a MobileOne model without the final classification layer.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::mobileone::{mobileone_no_final_layer, Config};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::s0();
/// let model = mobileone_no_final_layer(&cfg, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
