...
/// RepVGG model configuration.
///
/// # Example
///
/// ```
/// use fuel_transformers::models::repvgg::Config;
/// let cfg = Config::a0();
/// ```
#[derive(Clone)]
pub struct Config {
...
impl Config {
    ...
    /// RepVGG-B1g4 (51.8 M params, group convolutions g=4).
    ///
    /// # Example
    ///
    /// ```
    ...
    /// RepVGG-B2g4 (89.0 M params, group convolutions g=4).
    ///
    /// # Example
    ///
    /// ```
    ...
    /// RepVGG-B3g4 (110.9 M params, group convolutions g=4).
    ///
    /// # Example
    ///
    /// ```
...
/// Build a RepVGG model with a classification head.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::repvgg::{repvgg, Config};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::a0();
/// let model = repvgg(&cfg, 1000, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
...
/// Build a RepVGG model without the final classification layer.
///
/// # Example
///
/// ```no_run
/// # use fuel_transformers::models::repvgg::{repvgg_no_final_layer, Config};
/// # use fuel_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::a0();
/// let model = repvgg_no_final_layer(&cfg, vb)?;
/// # Ok::<(), fuel::Error>(())
/// ```
