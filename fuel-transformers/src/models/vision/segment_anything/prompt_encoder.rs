...
pub struct PromptEncoder {
    ...
    point_embeddings: Vec<fuel_nn::Embedding>,
    not_a_point_embed: fuel_nn::Embedding,
    mask_downscaling_conv1: fuel_nn::Conv2d,
    mask_downscaling_ln1: super::LayerNorm2d,
    mask_downscaling_conv2: fuel_nn::Conv2d,
    mask_downscaling_ln2: super::LayerNorm2d,
    mask_downscaling_conv3: fuel_nn::Conv2d,
    no_mask_embed: fuel_nn::Embedding,
...
impl PromptEncoder {
    /// Build the prompt encoder for the given image and embedding dimensions.
    pub fn new(
        embed_dim: usize,
        image_embedding_size: (usize, usize),
        input_image_size: (usize, usize),
        ...
        let not_a_point_embed = fuel_nn::embedding(1, embed_dim, vb.pp("not_a_point_embed"))?;
        let no_mask_embed = fuel_nn::embedding(1, embed_dim, vb.pp("no_mask_embed"))?;
        let cfg = fuel_nn::Conv2dConfig {
            stride: 2,
            ..Default::default()
        };
        let mask_downscaling_conv1 =
            fuel_nn::conv2d(1, mask_in_chans / 4, 2, cfg, vb.pp("mask_downscaling.0"))?;
        let mask_downscaling_conv2 = fuel_nn::conv2d(
            mask_in_chans / 4,
            mask_in_chans,
            2,
            cfg,
        ...
        let mask_downscaling_conv3 = fuel_nn::conv2d(
            mask_in_chans,
            embed_dim,
            1,
            Default::default(),
        ...
        for i in 0..num_points_embeddings {
            let emb = fuel_nn::embedding(1, embed_dim, vb_e.pp(i))?;
    ...
    /// Return the dense positional encoding for the image embedding grid.
    ...
    /// Encode point/box/mask prompts as sparse and dense embeddings.
    pub fn forward(
        &self,
