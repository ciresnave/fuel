...
pub static EMBEDDED: &[(&str, &[u8])] = &[
    (
        "add_assign_scaled",
        include_bytes!("../spv/add_assign_scaled.spv"),
    ),
    ...
    (
        "cast_f32_to_f16",
        include_bytes!("../spv/cast_f32_to_f16.spv"),
    ),
    (
        "cast_f16_to_f32",
        include_bytes!("../spv/cast_f16_to_f32.spv"),
    ),
    (
        "cast_f32_to_bf16",
        include_bytes!("../spv/cast_f32_to_bf16.spv"),
    ),
    (
        "cast_bf16_to_f32",
        include_bytes!("../spv/cast_bf16_to_f32.spv"),
    ),
    (
        "cast_f32_to_f64",
        include_bytes!("../spv/cast_f32_to_f64.spv"),
    ),
    (
        "cast_f64_to_f32",
        include_bytes!("../spv/cast_f64_to_f32.spv"),
    ),
    (
        "cast_f32_to_f8e4m3",
        include_bytes!("../spv/cast_f32_to_f8e4m3.spv"),
    ),
    (
        "cast_f8e4m3_to_f32",
        include_bytes!("../spv/cast_f8e4m3_to_f32.spv"),
    ),
    (
        "cast_f16_to_f8e4m3",
        include_bytes!("../spv/cast_f16_to_f8e4m3.spv"),
    ),
    (
        "cast_f8e4m3_to_f16",
        include_bytes!("../spv/cast_f8e4m3_to_f16.spv"),
    ),
    (
        "cast_bf16_to_f8e4m3",
        include_bytes!("../spv/cast_bf16_to_f8e4m3.spv"),
    ),
    (
        "cast_f8e4m3_to_bf16",
        include_bytes!("../spv/cast_f8e4m3_to_bf16.spv"),
    ),
    ...
    (
        "strided_copy_signed_b2",
        include_bytes!("../spv/strided_copy_signed_b2.spv"),
    ),
    (
        "strided_copy_signed_b4",
        include_bytes!("../spv/strided_copy_signed_b4.spv"),
    ),
    (
        "strided_copy_signed_b8",
        include_bytes!("../spv/strided_copy_signed_b8.spv"),
    ),
    ...
    (
        "masked_fill_b1",
        include_bytes!("../spv/masked_fill_b1.spv"),
    ),
    (
        "masked_fill_b2",
        include_bytes!("../spv/masked_fill_b2.spv"),
    ),
    (
        "masked_fill_b4",
        include_bytes!("../spv/masked_fill_b4.spv"),
    ),
    (
        "masked_fill_b8",
        include_bytes!("../spv/masked_fill_b8.spv"),
    ),
    ...
    (
        "pad_reflect_b1",
        include_bytes!("../spv/pad_reflect_b1.spv"),
    ),
    (
        "pad_reflect_b2",
        include_bytes!("../spv/pad_reflect_b2.spv"),
    ),
    (
        "pad_reflect_b4",
        include_bytes!("../spv/pad_reflect_b4.spv"),
    ),
    (
        "pad_reflect_b8",
        include_bytes!("../spv/pad_reflect_b8.spv"),
    ),
    (
        "pad_replicate_b1",
        include_bytes!("../spv/pad_replicate_b1.spv"),
    ),
    (
        "pad_replicate_b2",
        include_bytes!("../spv/pad_replicate_b2.spv"),
    ),
    (
        "pad_replicate_b4",
        include_bytes!("../spv/pad_replicate_b4.spv"),
    ),
    (
        "pad_replicate_b8",
        include_bytes!("../spv/pad_replicate_b8.spv"),
    ),
    (
        "pad_backward_const_b1",
        include_bytes!("../spv/pad_backward_const_b1.spv"),
    ),
    (
        "pad_backward_const_b2",
        include_bytes!("../spv/pad_backward_const_b2.spv"),
    ),
    (
        "pad_backward_const_b4",
        include_bytes!("../spv/pad_backward_const_b4.spv"),
    ),
    (
        "pad_backward_const_b8",
        include_bytes!("../spv/pad_backward_const_b8.spv"),
    ),
    (
        "pad_backward_reflect_f32",
        include_bytes!("../spv/pad_backward_reflect_f32.spv"),
    ),
    (
        "pad_backward_replicate_f32",
        include_bytes!("../spv/pad_backward_replicate_f32.spv"),
    ),
    (
        "pad_backward_reflect_f64",
        include_bytes!("../spv/pad_backward_reflect_f64.spv"),
    ),
    (
        "pad_backward_replicate_f64",
        include_bytes!("../spv/pad_backward_replicate_f64.spv"),
    ),
    (
        "pad_backward_reflect_bf16",
        include_bytes!("../spv/pad_backward_reflect_bf16.spv"),
    ),
    (
        "pad_backward_replicate_bf16",
        include_bytes!("../spv/pad_backward_replicate_bf16.spv"),
    ),
    (
        "pad_backward_reflect_f16",
        include_bytes!("../spv/pad_backward_reflect_f16.spv"),
    ),
    (
        "pad_backward_replicate_f16",
        include_bytes!("../spv/pad_backward_replicate_f16.spv"),
    ),
    (
        "write_slice_b1",
        include_bytes!("../spv/write_slice_b1.spv"),
    ),
    (
        "write_slice_b2",
        include_bytes!("../spv/write_slice_b2.spv"),
    ),
    (
        "write_slice_b4",
        include_bytes!("../spv/write_slice_b4.spv"),
    ),
    (
        "write_slice_b8",
        include_bytes!("../spv/write_slice_b8.spv"),
    ),
    (
        "concat_along_dim",
        include_bytes!("../spv/concat_along_dim.spv"),
    ),
    (
        "concat_along_dim_f16",
        include_bytes!("../spv/concat_along_dim_f16.spv"),
    ),
    (
        "concat_along_dim_bf16",
        include_bytes!("../spv/concat_along_dim_bf16.spv"),
    ),
    (
        "concat_along_dim_f64",
        include_bytes!("../spv/concat_along_dim_f64.spv"),
    ),
    ("conv2d_im2col", include_bytes!("../spv/conv2d_im2col.spv")),
    (
        "conv2d_im2col_bf16",
        include_bytes!("../spv/conv2d_im2col_bf16.spv"),
    ),
    (
        "flash_attention",
        include_bytes!("../spv/flash_attention.spv"),
    ),
    ...
    (
        "index_select_f16",
        include_bytes!("../spv/index_select_f16.spv"),
    ),
    (
        "index_select_bf16",
        include_bytes!("../spv/index_select_bf16.spv"),
    ),
    (
        "index_select_f64",
        include_bytes!("../spv/index_select_f64.spv"),
    ),
    (
        "matmul_q4_0_tiled",
        include_bytes!("../spv/matmul_q4_0_tiled.spv"),
    ),
    ...
    (
        "matmul_tiled_bf16_b",
        include_bytes!("../spv/matmul_tiled_bf16_b.spv"),
    ),
    ("matmul_coop", include_bytes!("../spv/matmul_coop.spv")),
    (
        "matmul_coop_bf16_bf16",
        include_bytes!("../spv/matmul_coop_bf16_bf16.spv"),
    ),
    (
        "matmul_coop_f16_f16",
        include_bytes!("../spv/matmul_coop_f16_f16.spv"),
    ),
    (
        "matmul_coop_bf16_bf16_bf16",
        include_bytes!("../spv/matmul_coop_bf16_bf16_bf16.spv"),
    ),
    (
        "matmul_small_bf16_bf16_f32",
        include_bytes!("../spv/matmul_small_bf16_bf16_f32.spv"),
    ),
    (
        "matmul_small_bf16_bf16_bf16",
        include_bytes!("../spv/matmul_small_bf16_bf16_bf16.spv"),
    ),
    (
        "matmul_small_f16_f16_f32",
        include_bytes!("../spv/matmul_small_f16_f16_f32.spv"),
    ),
    (
        "matmul_small_f16_f16_f16",
        include_bytes!("../spv/matmul_small_f16_f16_f16.spv"),
    ),
    (
        "flash_attn_f32",
        include_bytes!("../spv/flash_attn_f32.spv"),
    ),
    (
        "flash_attn_bf16",
        include_bytes!("../spv/flash_attn_bf16.spv"),
    ),
    (
        "flash_attn_f16",
        include_bytes!("../spv/flash_attn_f16.spv"),
    ),
    (
        "flash_attn_backward_q_f32",
        include_bytes!("../spv/flash_attn_backward_q_f32.spv"),
    ),
    (
        "flash_attn_backward_k_f32",
        include_bytes!("../spv/flash_attn_backward_k_f32.spv"),
    ),
    (
        "flash_attn_backward_v_f32",
        include_bytes!("../spv/flash_attn_backward_v_f32.spv"),
    ),
    (
        "matmul_coop_f16_f16_f16",
        include_bytes!("../spv/matmul_coop_f16_f16_f16.spv"),
    ),
    ...
    (
        "arg_reduce_last_dim_f32",
        include_bytes!("../spv/arg_reduce_last_dim_f32.spv"),
    ),
    (
        "scatter_add_f32",
        include_bytes!("../spv/scatter_add_f32.spv"),
    ),
    (
        "scatter_add_f64",
        include_bytes!("../spv/scatter_add_f64.spv"),
    ),
    (
        "scatter_add_bf16",
        include_bytes!("../spv/scatter_add_bf16.spv"),
    ),
    (
        "scatter_add_f16",
        include_bytes!("../spv/scatter_add_f16.spv"),
    ),
    (
        "arg_reduce_any_dim_f32",
        include_bytes!("../spv/arg_reduce_any_dim_f32.spv"),
    ),
    (
        "arg_reduce_any_dim_f64",
        include_bytes!("../spv/arg_reduce_any_dim_f64.spv"),
    ),
    (
        "arg_reduce_any_dim_bf16",
        include_bytes!("../spv/arg_reduce_any_dim_bf16.spv"),
    ),
    (
        "arg_reduce_any_dim_f16",
        include_bytes!("../spv/arg_reduce_any_dim_f16.spv"),
    ),
    ("index_add_f32", include_bytes!("../spv/index_add_f32.spv")),
    ("index_add_f64", include_bytes!("../spv/index_add_f64.spv")),
    (
        "index_add_bf16",
        include_bytes!("../spv/index_add_bf16.spv"),
    ),
    ("index_add_f16", include_bytes!("../spv/index_add_f16.spv")),
    (
        "arg_reduce_last_dim_f16",
        include_bytes!("../spv/arg_reduce_last_dim_f16.spv"),
    ),
    (
        "arg_reduce_last_dim_bf16",
        include_bytes!("../spv/arg_reduce_last_dim_bf16.spv"),
    ),
    (
        "arg_reduce_last_dim_f64",
        include_bytes!("../spv/arg_reduce_last_dim_f64.spv"),
    ),
    (
        "reduce_last_dim",
        include_bytes!("../spv/reduce_last_dim.spv"),
    ),
    (
        "reduce_last_dim_f16",
        include_bytes!("../spv/reduce_last_dim_f16.spv"),
    ),
    (
        "reduce_last_dim_bf16",
        include_bytes!("../spv/reduce_last_dim_bf16.spv"),
    ),
    (
        "reduce_last_dim_f64",
        include_bytes!("../spv/reduce_last_dim_f64.spv"),
    ),
    (
        "rms_norm_last_dim",
        include_bytes!("../spv/rms_norm_last_dim.spv"),
    ),
    (
        "rms_norm_last_dim_f16",
        include_bytes!("../spv/rms_norm_last_dim_f16.spv"),
    ),
    (
        "rms_norm_last_dim_bf16",
        include_bytes!("../spv/rms_norm_last_dim_bf16.spv"),
    ),
    (
        "rms_norm_last_dim_f64",
        include_bytes!("../spv/rms_norm_last_dim_f64.spv"),
    ),
    (
        "rms_norm_last_dim_backward",
        include_bytes!("../spv/rms_norm_last_dim_backward.spv"),
    ),
    ...
    (
        ...
        include_bytes!("../spv/softmax_last_dim_backward.spv"),
    ),
    (
        "softmax_last_dim_backward_f16",
        include_bytes!("../spv/softmax_last_dim_backward_f16.spv"),
    ),
    (
        "softmax_last_dim_backward_bf16",
        include_bytes!("../spv/softmax_last_dim_backward_bf16.spv"),
    ),
    (
        "softmax_last_dim_backward_f64",
        include_bytes!("../spv/softmax_last_dim_backward_f64.spv"),
    ),
    (
        "layer_norm_last_dim_backward",
        include_bytes!("../spv/layer_norm_last_dim_backward.spv"),
    ),
    (
        "layer_norm_last_dim_backward_f16",
        include_bytes!("../spv/layer_norm_last_dim_backward_f16.spv"),
    ),
    (
        "layer_norm_last_dim_backward_bf16",
        include_bytes!("../spv/layer_norm_last_dim_backward_bf16.spv"),
    ),
    (
        "layer_norm_last_dim_backward_f64",
        include_bytes!("../spv/layer_norm_last_dim_backward_f64.spv"),
    ),
    (
        "layer_norm_last_dim",
        include_bytes!("../spv/layer_norm_last_dim.spv"),
    ),
    (
        "layer_norm_last_dim_f16",
        include_bytes!("../spv/layer_norm_last_dim_f16.spv"),
    ),
    (
        "layer_norm_last_dim_bf16",
        include_bytes!("../spv/layer_norm_last_dim_bf16.spv"),
    ),
    (
        "layer_norm_last_dim_f64",
        include_bytes!("../spv/layer_norm_last_dim_f64.spv"),
    ),
