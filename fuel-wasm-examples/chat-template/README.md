# fuel-wasm-chat-template

Shared chat template support for fuel WASM LLM examples.
...
```toml
[dependencies]
fuel-wasm-chat-template = { path = "../chat-template" }
```

### Rust

```rust
use fuel_wasm_chat_template::{ChatTemplate, Message, Conversation, ChatTemplateOptions};
