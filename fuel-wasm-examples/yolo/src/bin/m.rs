use fuel_wasm_example_yolo::coco_classes;
use fuel_wasm_example_yolo::model::Bbox;
use fuel_wasm_example_yolo::worker::Model as M;
use fuel_wasm_example_yolo::worker::ModelPose as P;
